...
public class JWTOperations {
    ...
    public String createToken(GemUserDetails gemUserDetails) {
        // No custom claims for now
        Map<String, Object> claims = new HashMap<>();
        return Jwts.builder()
                .setClaims(claims)
                .setIssuer(JWT_ISSUER)
                .setSubject(gemUserDetails.getUsername())
    ...
    public Boolean isValidToken(String token, GemUserDetails gemUserDetails) {
        return (
                extractUsername(token).equals(gemUserDetails.getUsername()) &&
